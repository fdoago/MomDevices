...
namespace Vinos
{
	public class App
	{
		...
		protected static ServiceConnection ServiceConnection;
		...
		protected App () 
		{
			...
			ServiceConnection.ServiceConnected += (object sender, ServiceConnectedEventArgs e) => {
		...
		public static void StartLocationService()
		{
			...
			new Task ( () => { 
				...
				Android.App.Application.Context.StartService (new Intent (Android.App.Application.Context, typeof(ServiceClass)));

				// bind our service (Android goes and finds the running service by type, and puts a reference
				// on the binder to that service)
				// The Intent tells the OS where to find our Service (the Context) and the Type of Service
				// we're looking for (LocationService)
				Intent locationServiceIntent = new Intent (Android.App.Application.Context, typeof(ServiceClass));
				Log.Debug ("App", "Calling service binding");

				// Finally, we can bind to the Service using our Intent and the ServiceConnection we
				// created in a previous step.
				Android.App.Application.Context.BindService (locationServiceIntent, ServiceConnection, Bind.AutoCreate);
			} ).Start ();
		}
